// Check the AutoTyping.js Github Repo to get this code understanding
...
// Start Typing
const exampleText = ['Developer.', 'Designer.', 'Coder.'];
const exampleTyping = new AutoTyping('#skills', exampleText, {
    typeSpeed: 100,
    deleteSpeed: 100,
